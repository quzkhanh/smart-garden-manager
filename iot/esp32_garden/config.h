...
// Mẹo: "Fen" nên vào Firebase Console > Authentication > Users 
// để tạo một tài khoản email/mật khẩu riêng cho thiết bị này.
#define USER_EMAIL "park_river_98@gmail.com"
#define USER_PASSWORD "emmuoi36"

// 4. Area & User Identification
// Sau khi "fen" đăng nhập vào App, vào Firestore tìm UID của mình 
// và ID của khu vực vườn muốn điều khiển rồi điền vào đây nhé.
#define AREA_ID "ID_KHU_VƯC_TRÊN_FIRESTORE"
#define USER_UID "UID_CỦA_FEN"
