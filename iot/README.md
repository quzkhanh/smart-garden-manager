...
| **Cảm biến DHT22** | 1 | Đọc nhiệt độ và độ ẩm không khí |
| **Relay 2-4 Kênh** | 1 | Bật/tắt Máy bơm, Quạt, Phun sương |
| **Màn hình TFT ST7789** | 1 | Hiển thị trạng thái (240x240, SPI) |
| **Nút nhấn** | 4 | Điều khiển Bơm, Quạt, Phun sương, Mode |
| **Nguồn 12V + Hạ áp LM2596** | 1 | Cấp nguồn cho bơm, hạ áp 5V cho ESP32 |
| **Bơm nước MINI 12V** | 1 | Phục vụ tưới cây |
| **Quạt 12V** | 1 | Thông gió / làm mát |
